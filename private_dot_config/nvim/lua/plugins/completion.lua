	...
	-- GPT chat interface
	{
			...
			require("neoai").setup({
				...
				prompts = {
					context_prompt = function(context)
						return "You are a software engineer, collaborating with other sotware engineers to solve problems related to all areas of development.\n"
							...
							.. "Incorrect and long answers have a significant impact on the software engineer's reputation and career.\n"
							.. context
					end
				}
			})
		...
		keys = function()
			...
			return {
				{
					'<Leader>ait',
					function() neoai.toggle(true) end,
					':NeoAIToggle<CR>',
					desc = 'Toggle Neo AI'
				},
				{
